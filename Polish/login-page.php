            ...
            <ul class="navbar-nav ms-auto" id="navbar-right">
                <li class="nav-item dropdown" id="navbar-dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="../login-page.php">Angielski</a></li>
...
<div class="container mt-auto">
  <div class="text-center" id="heading">
    <h1>Witam!</h3>
    <h4>Podaj dane logowania, aby się zalogować!</h3>
  </div>
  <form class="container bg-light bg-gradient bg-opacity-75" id="loginForm" method="POST">
          ...
          <div class="mb-3 form-check">
            ...
            <label class="form-check-label" for="exampleCheck1">Pozostaw mnie zalogowanym</label>
          </div>
      <button type="submit" name="submit" class="btn btn-primary">Zalogować się</button>
  </form>
  <div class="text-center sideNote">
    <p style="margin-bottom: 0;">Pierwszy raz na naszym serwisie?</p>
    <a style="text-decoration:none;" href="registration-page.php">Utwórz konto</a>
  </div>
</div>
<br>
<!-- Footer -->
