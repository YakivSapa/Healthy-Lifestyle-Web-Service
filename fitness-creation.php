            ...
            <ul class="navbar-nav ms-auto" id="navbar-right">
                <li class="nav-item dropdown" id="navbar-dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" href="Polish/fitness-creation.php">Polish</a></li>
                    </ul>
                  </li>
...
<div class="container text-center">
    <h1 id="heading">Creation of a fitness schedule</h1>
    <p>
        Create the part of your fitness plan by writing down exercises! 
        Enter the quantity of exercises and then simply fill out the form!
    </p>
</div>
<!-- Exercise Input -->
<div class="container text-center" id="exerciseInput">
    <label class="form-label">Quantity of exercises:</label>
